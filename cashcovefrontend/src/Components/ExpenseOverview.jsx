...
import { formatAmount, formatDate, generateSmoothPath, prepareIncomeLineChartData } from './incomeChartUtils';
...
const ExpenseOverview = ({transactions, onAddExpense}) => {
  ...
  return (
    <div className="card bg-green-50 shadow py-10 px-5">
        <div className="flex items-center justify-between">
            ...
            <button className='add-btn bg-white text-green-600 rounded text-sm px-2 py-1 flex items-center' onClick={onAddExpense}>
