        ...
        <div className="relative p-4 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="relative bg-white rounded-xl shadow-2xl border border-gray-100">
                ...
                <div className="flex items-center justify-between p-5 md:p-6 border-gray-100 rounded-t-xl">
                    ...
                    onClick={onClose}
                    type='button'
                    className="text-gray-500 bg-gray-50 justify-center hover:bg-gray-100 hover:text-gray-700 rounded-lg text-sm w-9 h-9 inline-flex items-center transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                        <X className='w-4 h-4'/>
                    </button>
                </div>
