        ...
        <div className="card p-4 mb-4">
          ...
          <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
            <div>
              ...
              <select value={type} className='w-full border rounded px-3 py-2' id="type" onChange={e => setType(e.target.value)}>
            ...
            <div>
              ...
              <select value={sortField} className='w-full border rounded px-3 py-2' id="sortfield" onChange={e => setSortField(e.target.value)}>
            ...
            <div>
              ...
              <select value={sortOrder} className='w-full border rounded px-3 py-2' id="sortorder" onChange={e => setSortOrder(e.target.value)}>
